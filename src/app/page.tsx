      ...
      <main className="relative max-w-4xl mx-auto px-6 py-16 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            {
              icon: Brain,
              label: 'TCC Adaptativa',
              desc: 'Respostas baseadas em técnicas validadas',
              delay: '600ms',
            ...
            },
            {
              icon: Activity,
              label: 'PHQ-9 & GAD-7',
              desc: 'Escalas clínicas padrão-ouro',
              delay: '700ms',
              color: 'group-hover:text-fuchsia-400',
              glow: 'group-hover:shadow-[0_0_20px_rgba(232,121,249,0.2)]',
            },
            {
              icon: Shield,
              label: 'Protocolo de Crise',
              desc: 'Detecção determinística de risco',
              delay: '800ms',
            ...
            >
              <f.icon className={`w-5 h-5 text-violet-400 mb-3 transition-all duration-300 ${f.color}`} />
